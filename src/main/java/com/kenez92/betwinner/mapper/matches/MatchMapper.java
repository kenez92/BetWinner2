...
public class MatchMapper {
    public Match mapToMatch(final MatchDto matchDto) {
        return Match.builder()
                ...
                .awayTeamCourse(matchDto.getAwayTeamCourse())
                .drawCourse((matchDto.getDrawCourse()))
                .homeTeamCourse(matchDto.getHomeTeamCourse())
    ...
    public MatchDto mapToMatchDto(final Match match) {
        return MatchDto.builder()
                ...
                .awayTeamCourse(match.getAwayTeamCourse())
                .drawCourse((match.getDrawCourse()))
                .homeTeamCourse(match.getHomeTeamCourse())
